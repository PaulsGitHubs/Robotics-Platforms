...
export async function initScene() {
  ...
  // Default physics mode can be toggled via UI (Light / Ammo)
  // Start the deterministic physics loop attached to Cesium postRender
  try {
    ...
    console.warn('Failed to start deterministic physics loop:', e);
  }
